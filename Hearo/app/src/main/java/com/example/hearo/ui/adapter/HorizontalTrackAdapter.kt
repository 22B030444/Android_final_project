...
import com.example.hearo.databinding.ItemHorizontalTrackBinding

class HorizontalTrackAdapter(
    private val onTrackClick: (UniversalTrack) -> Unit,
    private val onTrackLongClick: ((UniversalTrack) -> Unit)? = null
) : ListAdapter<UniversalTrack, HorizontalTrackAdapter.ViewHolder>(DiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = ItemHorizontalTrackBinding.inflate(
    ...
    inner class ViewHolder(
        private val binding: ItemHorizontalTrackBinding
